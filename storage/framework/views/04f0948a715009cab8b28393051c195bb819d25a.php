        ...
        <div class="row justify-content-between gy-4 mt-4">
          ...
          <div class="col-lg-8">
            <div class="portfolio-description">
              <h2 class="title"><?php echo e($katalog->title); ?></h2>

              <div class="content">
                <p class="post-summernote"><?php echo $katalog->summernote; ?></p>
...
<?php echo $__env->make('layouts.katalog', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\applications\jpbooks\resources\views/katalog-details.blade.php ENDPATH**/ ?>