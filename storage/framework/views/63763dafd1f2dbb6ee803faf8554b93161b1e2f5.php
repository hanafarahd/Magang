      ...
      <nav>
        <div class="container">
          <ol>
            ...
            <li class="title"><?php echo e($kjawabans->title); ?></li>
          </ol>
        </div>
      </nav>
    </div><!-- End Breadcrumbs -->
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-8">
            ...
            <article class="blog-details">
              ...
              <h2 class="title"><?php echo e($kjawabans->title); ?></h2>

              <?php if($kjawabans->password == $pass): ?>
              ...
              <div class="col-12 col-lg-4">
                <div class="search-form">
                  ...
                  <?php endif; ?>
                  <form action="/<?php echo e($kjawabans->slug); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div style="display: flex;">
                      <input type="text" id="pass" name="pass" value="<?php echo e($kjawabans->pass); ?>">
...
<?php echo $__env->make('layouts.kjawabans', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\applications\jpbooks\resources\views/kjawabans.blade.php ENDPATH**/ ?>