...
<head>
  ...
  <!-- CodeMirror -->
  <link rel="stylesheet" href="<?php echo e(asset('template/plugins/codemirror/codemirror.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('template/plugins/codemirror/theme/monokai.css')); ?>">
  <!-- SimpleMDE -->
      ...
      <!-- ./row -->
        ...
        <section class="content-header">
            ...
            <div class="row mb-2">
                ...
                <div class="container">
                <a href="/post" class="btn btn-success">Tambah +</a>
                <div class="row">
                    ...
                    <tr>
                        ...
                        <a href="/tampilkanpost/<?php echo e($post->slug); ?>" class="btn btn-info">Edit</a>
                        <a href="/deletepost/<?php echo e($post->slug); ?>" class="btn btn-danger">Delete</a>
...
<!-- CodeMirror -->
<script src="<?php echo e(asset('template/plugins/codemirror/codemirror.js')); ?>"></script>
<script src="<?php echo e(asset('template/plugins/codemirror/mode/css/css.js')); ?>"></script>
<script src="<?php echo e(asset('template/plugins/codemirror/mode/xml/xml.js')); ?>"></script>
<script src="<?php echo e(asset('template/plugins/codemirror/mode/htmlmixed/htmlmixed.js')); ?>"></script>
...
<?php /**PATH D:\applications\jpbooks\resources\views/layouts/coba.blade.php ENDPATH**/ ?>