...
<?php $__env->startSection('content'); ?>
    ...
    <section id="about" class="about">
        <div class="container" data-aos="fade-up">
          ...
          <div class="section-header">
            <h2>About Us</h2>
            <p>Di bawah naungan PT Temprina Media Grafika, JP BOOKS terus berkembang dan berinovasi mengikuti perkembangan zaman. Sebagai penerbit yang beroperasi sejak tahun 2002, kami senantiasa berupaya dan bertumbuh, untuk menyediakan buku-buku terbaik bagi masyarakat. Di dukung oleh para tenaga ahli, kami menyediakan banyak buku berkualitas yang sarat akan nilai-nilai pendidikan. Kami memiliki tim-tim handal yang bekerja keras, mulai dari proses kreatif, produksi, pengemasan, hingga pemasaran. Kami berupaya agar buku yang sampai ke tangan anda dalam kondisi yang terbaik.
            </p>
          </div>
    ...
    <section id="call-to-action" class="call-to-action">
        <div class="container text-center" data-aos="zoom-out">
          <a href="https://www.youtube.com/watch?v=2OA2MecVx24" class="glightbox play-btn"></a>
          <h3>Call To Action</h3>
          <p> Klik Sini</p>
          <a class="cta-btn" href="https://www.youtube.com/watch?v=2OA2MecVx24">Call To Action</a>
        </div>
...
<?php echo $__env->make('layouts.about', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\applications\jpbooks\resources\views/about.blade.php ENDPATH**/ ?>