...
<body>
  ...
  <br>
  <br>
  <h1 class="text-center mb-5 mt-5"> Edit Post Kunci Jawaban </h1>
              ...
              <div class="card-body">
                  ...
                  <div class="mb-3">
                    ...
                    <select id="tampilkan" size="1" onChange="sembarang()">
                        <option selected>"<?php echo e($post->password); ?>"</option>
                        <option value="Iya">Iya</option>
                        <option value="Tidak">Tidak</option>
                    </select>
                  </div>
...
dan fungsinya wajib.
-->
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\applications\jpbooks\resources\views/tampilkuncijawaban.blade.php ENDPATH**/ ?>