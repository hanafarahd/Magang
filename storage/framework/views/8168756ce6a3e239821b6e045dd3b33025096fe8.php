            ...
            <table class="table">
              ...
              <tr>
                ...
                <td><?php echo e($post->image); ?>
                  ...
                  <img src="<?php echo e(asset('imagepost/'.$post->image)); ?>" alt="" style="width: 100px;">
                </td>
                ...
                <td style="display: flex; justify-content: center;">
                  ...
                  <a href="/tampilkanpost/<?php echo e($post->id); ?>" class="nav-link">
                    <i class="fas fa-edit"></i>
                  </a>

                  <a href="/deletepost/<?php echo e($post->id); ?>" class="nav-link">
                    <i class="fas fa-trash-alt"></i>
                  </a>
                  
                  <a href="/blog_details/<?php echo e($post->slug); ?>" class="nav-link">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\applications\jpbooks\resources\views/posts.blade.php ENDPATH**/ ?>