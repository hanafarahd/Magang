      ...
      <section id="blog" class="blog">
        <div class="container" data-aos="fade-up">
          ...
          <div class="row gy-4 posts-list">
            ...
            <?php $__currentLoopData = $kjawabans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kjawaban): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="col-xl-4 col-md-6">
              ...
              <article>
                ...
                <h2 class="title">
                  <a href="<?php echo e(url('/kuncijawaban/'.$kjawaban->slug)); ?>"><?php echo e($kjawaban->title); ?></a>
                </h2>
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="post-meta">
                    ...
                    <p class="post-date">
                      <time datetime="2022-01-01"><?php echo e($kjawaban->created_at); ?></time>
                    </p>
                  </div>
...
<?php echo $__env->make('layouts.kjawaban', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\applications\jpbooks\resources\views/kjawaban.blade.php ENDPATH**/ ?>