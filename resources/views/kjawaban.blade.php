          ...
          <div class="row gy-4 posts-list">
            ...
            <div class="col-xl-4 col-md-6">
              ...
              <article>
                ...
                <h2 class="title">
                  <a href="{{ url('/kuncijawaban/'.$kjawaban->slug) }}">{{ $kjawaban->title }}</a>
                </h2>
                ...
                <div class="d-flex align-items-center">
                  <div class="post-meta">
                    <p class="post-date">
                      <time datetime="2022-01-01">{{ $kjawaban->created_at }}</time>
                    </p>
                  </div>
